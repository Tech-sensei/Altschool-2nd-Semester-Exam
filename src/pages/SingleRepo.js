        ...
        <article className="singlerepo__container container flex">
          <div className="singlerepo__container--contents">
            <div className="singlerepo__header">
              <a href="https://github.com/Tech-sensei/" target="blank">
            ...
            <div className="singlerepo__body flex">
              <h3>{name}</h3>
              <p>
                This is a project built by Tobiloba Ibraheem, A very diligent
                and hardworking guy. what problem will the project solve? The
                simple answer is that it will solve all digital problems in the
                world😉
              </p>
